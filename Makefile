...
ALL: recolor_text test_game_mpitassi test_game_akasparian
...
.PHONY: clean
clean :
	rm -f recolor_text.o recolor_text libgame.a test_game_mpitassi test_game_mpitassi.o test_game_akasparian test_game_akasparian.o

.PHONY: test
test : test_mpitassi test_akasparian
